...
function uploadImage(event){
  ...
  function displayOtherBlogs(){
    ...
    let otherBlogContainer = document.getElementByClassName('row');
    ...
    blogs.forEach((blog)=>{
       ...
       <div class="blog_news">
       <div class="img-responsive blog-image">
  ...
  function dipslayBlogPosts(){
     let postTitle = document.getElementById('cardTitle');
     let postImage = document.getElementById('blog-image');
     let postBody = document.getElementById('cardBody');
     let postDate = document.getElementById('dateWrapper');
     let postAuthor = document.getElementById('list-inline');
